...
class FillupsControllerTest < ActionController::TestCase
    ...
    context 'for an authenticated user' do
      ...
      should 'not create a fillup given incorrect/incomplete params' do
        assert_no_difference('Fillup.count') do
          post :create, fillup: { miles_driven: @fillup.miles_driven, price_of_gas: @fillup.price_of_gas, user_id: users(:matt).id }
        end
      end
      should 'create fillup given correct params for the Fillup' do
        assert_difference('Fillup.count') do
          post :create, fillup: { amount_of_gas: @fillup.amount_of_gas, date_of_fillup: @fillup.date_of_fillup, miles_driven: @fillup.miles_driven, price_of_gas: @fillup.price_of_gas, user_id: users(:matt).id }
        end
  ...
  context '#update' do
    context 'for an unauthenticated user' do
      should 'redirect to the login page' do
        put :update, id: @fillup, fillup: { amount_of_gas: @fillup.amount_of_gas, date_of_fillup: @fillup.date_of_fillup, miles_driven: @fillup.miles_driven, price_of_gas: @fillup.price_of_gas }
        assert_response :redirect
        assert_redirected_to new_user_session_path
      end
    end
    context 'for an authenticated user' do
      ...
      should 'update fillup when the information has changed' do
        put :update, id: @fillup, fillup: { amount_of_gas: 12.2, date_of_fillup: @fillup.date_of_fillup, miles_driven: @fillup.miles_driven, price_of_gas: @fillup.price_of_gas }
        assert_redirected_to fillup_path(assigns(:fillup))
      end
      should 'not update the fillup given invalid parameters' do
        put :update, id: @fillup, fillup: { amount_of_gas: 'two', date_of_fillup: @fillup.date_of_fillup, miles_driven: @fillup.miles_driven, price_of_gas: @fillup.price_of_gas }
        assert_response :unprocessable_entity
      end
      should 'not update the fillup of another user' do
        @second_fillup = fillups(:two)
        put :update, id: @second_fillup.id, fillup: { amount_of_gas: 12.2, date_of_fillup: @second_fillup.date_of_fillup, miles_driven: @second_fillup.miles_driven, price_of_gas: @second_fillup.price_of_gas }
        assert_response :unprocessable_entity
      end
     end
  end
